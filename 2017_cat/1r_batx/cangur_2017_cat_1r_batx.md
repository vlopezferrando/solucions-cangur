...
Si Maria dóna $x$ euros a cadascun dels germans, ella es quedarà amb $24-3x$ euros,
i els seus germans en tindran $12+x$. Per tal que tots acaben amb la
mateixa quantitat:

$$24-3x=12+x \quad\Rightarrow $$
$$\Rightarrow\quad 12=4x \quad\Rightarrow\quad x=3$$
...
![Solució 15, nivell de 1r de batxillerat del Cangur 2017 a Catalunya]({filename}solucions/15.png)
...
![Solució 19, nivell de 1r de batxillerat del Cangur 2017 a Catalunya]({filename}solucions/19.png)
...
![Solució 27, nivell de 1r de batxillerat del Cangur 2017 a Catalunya]({filename}solucions/27.png)
...
![Solució 28, nivell de 1r de batxillerat del Cangur 2017 a Catalunya]({filename}solucions/28.png)
...
Els divisors de $2017$ són els productes de totes les diferents combinacions
dels seus factors primers. Aquests factors primers són:

$$2017=2^5\cdot 3^2\cdot 7$$
...
i per tant l'única solució que pot ser correcta és $2017^{18}$ i la solució és
la **C**.
